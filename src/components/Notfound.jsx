...
export const Notfound = () => {
  return (
    <>
      <div className="md:w-1/2 w-full bg-red-600 py-3 flex flex-col items-center gap-3 md:gap-2 my-5  mx-auto justify-center ">
      <BiError className="text-7xl"/>
        <p className="text-xl font-bold text-white">404 Not Found</p>
        <p className="text-sm font-bold text-white">This page does not exist yet!</p>
